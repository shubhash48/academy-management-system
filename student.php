...
if (isset($_POST['save']) && $_POST['action'] != 'update') {
    ...
    if ($existingContact->num_rows > 0 && $_POST['action'] != "update") {
    ...
    $sql = $conn->query(" UPDATE student SET  sname = '$sname', contact = '$contact',  address='$address', course = '$course', joindate='$joindate', emailid = '$emailid' WHERE id = '$id'");
